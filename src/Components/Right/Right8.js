    ...
    return (
        <div className="bg-white mx-2 mt-4 text-dark d-flex justify-content-center align-items-center">
            <div className="shadow-lg" ref={ref} style={{ width: "800px" }}>
                <section className={`p-5 pb-2 m-0 text-center text-white bg-${color} `}>
                    <h1 className={`text-white mb-4 m-0 p-0 fw-bolder`}>
                        {fname === "" ? "John" : fname}{" "}
                        {lname === "" ? "Doe" : lname}
                    </h1>
                ...
                <div className="px-5 d-flex">
                    <div className="p-0 mt-3">
                        <section className={`d-flex justify-content-start align-items-start flex-column my-3 p-2 border border-${color} rounded`}>
                        ...
                        <div className={`my-3 p-2 border border-${color} rounded`}>
                            <h5
