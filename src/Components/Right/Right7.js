    ...
    return (
        <div className="bg-white mx-2 mt-4 text-dark d-flex justify-content-center align-items-center">
            <div className="shadow-lg" id="template" style={{ width: "800px" }}>
                <section className="p-5 pb-2 m-0 text-center" style={{ background: "#e3e2e1" }} >
                    <h1 className={` text-${color} mb-4 m-0 p-0 fw-bolder`}>
                        {fname === "" ? "John" : fname}{" "}
                        {lname === "" ? "Doe" : lname}
                    </h1>
                    <h5 className={`m-0 my-1 fw-bold text-${color}`}>
                        {profession === ""
                            ? "Business Develpment Manager"
                            : profession}
                    </h5>
                    <div className="m-0 mb-1 text-black">
                        {profession_description === ""
                            ? " Professional Lorem ipsum dolor sit amet, consectetur adipisicingelit Nesciunt porro consectetur libero"
                            : profession_description}
                    </div>
                </section>
                <section className="d-flex justify-content-around text-white" style={{ background: "#2C343F" }}>
                ...
                <div className="px-5 d-flex">
                    <div className="px-3 mt-3" style={{ background: "#e3e2e1" }}>
                    ...
                    <div className="ps-5 mt-3">
                        <div className="my-3 rounded p-3" style={{ background: "#e3e2e1" }}>
                            <h5
                                className={`text-${color} fst-italic text-center fw-bold`}
                            >
                                <u>SKILLS</u>
                            </h5>
