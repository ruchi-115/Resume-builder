      ...
      <div className="shadow-lg" id="template" style={{ width: "800px" }}>
        ...
        <section className="d-flex justify-content-around">
          <div className=" my-2 p-0 d-flex  fw-lighter">
            ...
            <div>{props.email === "" ? "jhon.doe@gmail.com" : props.email}</div>
          </div>
          <div className=" my-2  p-0 d-flex fw-lighter">
            <div className={`text-${props.color} mx-1`}>
          ...
          <div className=" my-2 p-0 d-flex fw-lighter">
            ...
            <div>{props.linkedIn === "" ? "linkedin.com" : props.linkedIn}</div>
          </div>
          <div className=" my-2  p-0 d-flex fw-lighter">
            <div className={`text-${props.color} mx-1`}>
        ...
        <section className="px-5">
          <div className="my-3 ">
            <h5 className={`text-${props.color} fst-italic fw-bold`}>SKILLS</h5>
          ...
          <div className="my-3">
            <h5 className={`text-${props.color} fst-italic fw-bold`}>
              WORK EXPERINCE
            </h5>
            <div className="my-1">
            ...
            <div className={`my-3 d-${props.addCompanyText}`}>
              ...
              <div className="d-flex justify-content-between m-0 p-0">
                <div className="fw-lighter d-flex">
                  ...
                  {props.dateto2 === "" ? "2017-06" : props.dateto2}
                </div>
                <div className="fw-lighter d-flex">
          ...
          <div className="my-3">
            ...
            <div>
              ...
              <div className="fw-lighter m-0 p-0 d-flex">
                ...
                {props.dateto3 === "" ? "2010-06" : props.dateto3}
              </div>
            </div>
          </div>
